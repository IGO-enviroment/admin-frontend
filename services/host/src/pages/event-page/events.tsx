...
import { Box, Button, Container, Drawer, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField } from "@mui/material";
...
export const EventsList = () => {
    ...
    return (
        <>
            ...
            <EventDrawer closeDrawer={closeDrawer} handleSubmit={handleSubmit} isVisible={isVisible} />
        </>
    );
};